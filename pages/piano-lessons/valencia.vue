...
import { pianoValenciaMetaData } from './../utils/metaData.js'

const { isDarkMode } = defineProps(['isDarkMode']);

useHead(pianoValenciaMetaData)
  ...
  <section id="clases-piano" :class="{ 'dark-mode': isDarkMode }">
    ...
    <div class="piano-classes">
      <div class="piano-classes-info">
        <h2>
          Learn to play the piano with passion and skill from Valencia!
        </h2>
        ...
        <p>Start your lessons from Valencia.</p>
